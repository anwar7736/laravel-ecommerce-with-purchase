            ...
            <div class="container-fluid">
                ...
                <a href="{{ route('admin.dashboard')}}" class="topnav-logo">
                    <span class="topnav-logo-lg">
                        <img src="{{ asset('backend/images/softitsecurity.png')}}" alt="" height="40">
                    </span>
                    <span class="topnav-logo-sm">
                        <img src="{{ getImage()}}" alt="" height="16">
                    </span>
                </a>
                ...
                <div class="leftside-menu leftside-menu-detached">
                    ...
                    <div class="leftbar-user">
                        <a href="javascript: void(0);">
                            <img src="{{  getImage()}}" alt="user-image" height="42" class="rounded-circle shadow-sm">
