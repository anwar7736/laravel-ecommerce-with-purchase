...
class Util {
	...
	public function increaseProductStock($product_id,$size_id, $stock){

		$item=ProductStock::where(['product_id'=>$product_id,'size_id'=>$size_id])->first();
	...
	public function updateProductStock($product_id, $size_id, $old_stock, $new_stock){
	...
	public function decreaseProductStock($product_id, $size_id, $stock){
